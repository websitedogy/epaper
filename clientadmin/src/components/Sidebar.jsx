...
const Sidebar = ({ activeMenu, onMenuChange, clientData, onLogout }) => {
  ...
  const handleMenuClick = (item) => {
    // Call the existing onMenuChange for backward compatibility
  ...
  return (
    <>
      ...
      <aside
        ...
        } lg:translate-x-0 w-64 bg-white border-r border-gray-200 shadow-lg`}
      >
        <div className="flex flex-col h-full">
          {/* Logo/Header */}
          <div className="p-6 border-b border-gray-200">
            <div className="flex items-center gap-3">
              <div className="flex items-center justify-center w-10 h-10 bg-gradient-to-r from-indigo-600 to-purple-600 rounded-lg">
                <svg
